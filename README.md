# lonskaya [![Build Status](https://travis-ci.org/anatolibarski/lonskaya.svg?branch=master)](https://travis-ci.org/anatolibarski/lonskaya)
...
To optimize the lonskaya application for production, run:
