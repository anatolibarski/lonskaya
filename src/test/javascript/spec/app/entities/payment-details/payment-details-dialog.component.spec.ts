...
import { PaymentDetailsDialogComponent } from '../../../../../../main/webapp/app/entities/payment-details/payment-details-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('PaymentDetails Management Dialog Component', () => {
        let comp: PaymentDetailsDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(PaymentDetailsDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'paymentDetailsListModification', content: 'OK'});
